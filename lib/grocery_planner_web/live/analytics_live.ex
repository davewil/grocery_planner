defmodule GroceryPlannerWeb.AnalyticsLive do
  ...
  defp load_data(socket) do
    ...
    inventory_summary = Analytics.get_inventory_summary(account_id, user)
          ...
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-xs text-gray-400 mt-1">{@inventory_summary.total_entries} individual units</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="flex items-baseline gap-2">
                  <h3 class="text-2xl font-bold text-gray-900">{@expiration_summary.expiring_7_days}</h3>
                  <span class="text-sm text-gray-500">items</span>
                </div>
                <p class="text-xs text-red-500 mt-1">{@expiration_summary.expired_count} already expired</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-6">
              <div class="flex items-center justify-between p-4 bg-red-50 rounded-xl border border-red-100">
                ...
                <span class="text-xl font-bold text-red-700">{@expiration_summary.expired_count}</span>
              </div>
              ...
              <div class="flex items-center justify-between p-4 bg-orange-50 rounded-xl border border-orange-100">
                ...
                <span class="text-xl font-bold text-orange-700">{@expiration_summary.expiring_7_days}</span>
              </div>
              ...
              <div class="flex items-center justify-between p-4 bg-yellow-50 rounded-xl border border-yellow-100">
                ...
                <span class="text-xl font-bold text-yellow-700">{@expiration_summary.expiring_30_days}</span>
              </div>
            </div>
