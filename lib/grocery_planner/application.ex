defmodule GroceryPlanner.Application do
  ...
  def start(_type, _args) do
    ...
    # Non-blocking by default, configurable via :require_ai_service
    # Skip in test environment to avoid interfering with Req.Test stubs
    if result_ok?(result) and Application.get_env(:grocery_planner, :validate_ai_on_startup, false) do
      Task.start(fn ->
        Process.sleep(2_000)
        validate_ai_service()
      end)
