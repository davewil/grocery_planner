defmodule GroceryPlanner.Inventory.GroceryItemTag do
  @moduledoc false
  use Ash.Resource,
  ...
  relationships do
    ...
    many_to_many :grocery_items, GroceryPlanner.Inventory.GroceryItem do
      through GroceryPlanner.Inventory.GroceryItemTagging
      source_attribute_on_join_resource :tag_id
      destination_attribute_on_join_resource :grocery_item_id
    end
  end
